  ...
  <h1 style='text-align: center'>
    <?php
        ...
        try {
            ...
            if ($renglones==1) {
              echo "<br><br><br><br>Producto: ".$result["producto_nombre"]."<br>";
              echo "Precio: $".$result["producto_precio"]."<br>";
              echo "Stock: ".$result["producto_stock"]."<br><br><br>";
              echo "<img src='".$result["producto_imagen"]."' width='300px' height='300px'>";
            }
            else{
